...
No. 11 | Star ratings on the reviews page were continuously showing 5 stars on the homepage, but the correct individual score given was on each written detail page. Eg. A user gives 3 stars, this would show in that page where you can comment. But on the review_list page it would show as 5 still. | After confirming the ratings were saved properly in the model, I updated the star display look to check the post.rating. 
